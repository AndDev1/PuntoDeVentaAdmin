...
public class jfrmLogin extends javax.swing.JFrame {
    ...
    Usuario usr;
    private static String codePOS = "1";
    String vAcceso;
            ...
            try {
                ...
                if (usr != null) {
                    if (usr.getBloqueo() == 1) {
                        ...
                        dispose();
                        vAcceso = usrLogic.getAcceso(user, pwd, codePOS);
                        if (!"S".equals(vAcceso)){
                            valForms.msjWarn(TagHelper.getTag("jfrmLogin.privPos"));
                            System.exit(0);
                        }
                        Util.serializeUser(usr);
                        PuntoVentaMDI mdi = new PuntoVentaMDI();
                        mdi.setVisible(true);
                    }
                } else {
