            ...
            if (vDateI <= vDateF) {
                ...
                if ("Historial de Venta por Articulo".equals(this.getTitle())) {
                    ...
                    if (true == pcv.getCountVenta(vFechaI, vFechaF, usuario)) {
                        printService.printICEPdf("CountVenta", "countSale");
                        val.msjInfo("Tome su ticket en la impresora");
                    }
                }
            } else {
                val.msjWarn("La Fecha Inicial no debe ser mayor a la fecha final");
            }
