...
public class Util {
    ...
    /**
     * Devuelve una cadena con el formato siguiente. [nombre del día] [día del mes] [mes] [año] [hora].
     * Por ejemplo: lunes 28 enero 2013 12:01
     *
     * @param date La fecha a formatear
     * @return Una cadena con el formato especificado anteriormente. En caso de excepción se devuelve una cadena vacía.
     */
